...
import ru.incrementstudio.incapi.configs.templates.PotionEffectTemplate;

import java.util.List;

public class EffectUtil {
    public static void addEffectFromTemplate(LivingEntity entity, PotionEffectTemplate effect) {
        entity.addPotionEffect(effect.getPotionEffect());
    }

    public static void addEffectsFromTemplate(LivingEntity entity, List<PotionEffectTemplate> effects) {
        for (PotionEffectTemplate effect : effects) {
            addEffectFromTemplate(entity, effect);
        }
    }
